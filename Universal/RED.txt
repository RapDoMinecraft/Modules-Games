...
local redzlib = {
	Themes = {
		Darker = {
			...
			["Color Stroke"] = Color3.fromRGB(47, 47, 47),
		...
		Purple = {
			...
			["Color Stroke"] = Color3.fromRGB(3, 3, 3),
...
function redzlib:MakeWindow(Configs)
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			Title = "Fechar Chaos Hub",
			Text = "Tem Certeza que deseja Fechar o Chaos Hub ?",
			Options = {
				{"Sim", function()
					ScreenGui:Destroy()
				end},
	...
	function Window:MinimizeBtn()
		...
		if Minimized then
			...
			CreateTween({MainFrame, "Size", SaveSize, 0.75, true})
	...
	function Window:Dialog(Configs)
		...
		local Frame = Create("Frame", {
			Active = true,
			Size = UDim2.fromOffset(250 * 2.08, 150 * 2.08),
